CREATE TABLE `/All of Us-cdb223/HIN - HIE/CCDA/IdentifiedData/OMOP_spark/post-processed/observation
` AS
    SELECT distinct 
      o.observation_id,
      o.person_id,
...
--         on vcn.concept_id = o.value_as_concept_i`
        ...
        AND o.observation_type_concept_id IS NOT NULL;