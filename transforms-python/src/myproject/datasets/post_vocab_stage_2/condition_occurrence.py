...
def compute(source_df, codemap):
    ...
    df = df.join(codemap, source_df.condition_concept_source_system == codemap.src_vocab_code_system and \
                               source_df.condition_concept_source_code == codemap.src_code)
