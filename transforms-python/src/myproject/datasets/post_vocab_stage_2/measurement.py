...
@transform_df(
    Output("/All of Us-cdb223/HIN - HIE/CCDA/datasets/post_vocab_stage_2/measurement"),
...
def compute(measurements, codemap):
    ...
    df = df.dropColumns(['measurement_concept_source_system','measurement_concept_source_code'])
