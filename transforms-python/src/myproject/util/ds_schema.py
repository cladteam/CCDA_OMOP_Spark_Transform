...
domain_dataset_schema = {
    ...
    T.StructField('birth_datetime', T.TimestampType(), True),
    ...
    T.StructField('month_of_birth', T.IntegerType(), True),
    T.StructField('day_of_birth', T.IntegerType(), True),
    T.StructField('race_concept_id', T.IntegerType(), True),
    T.StructField('ethnicity_concept_id', T.IntegerType(), True),
    T.StructField('person_source_value', T.StringType(), True),
    ...
    T.StructField('person_id', T.LongType(), True),
    T.StructField('condition_occurrence_id', T.LongType(), True),
    T.StructField('visit_occurrence_id', T.LongType(), True),
    T.StructField('condition_concept_id', T.IntegerType(), True),
    T.StructField('condition_start_date', T.DateType(), True),
    T.StructField('condition_start_datetime', T.TimestampType(), True),
    ...
    T.StructField('stop_reason', T.StringType(), True),
    T.StructField('condition_source_value', T.StringType(), True),
    ...
    T.StructField('verbatim_end_date', T.DateType(), True),
    T.StructField('visit_occurrence_id', T.LongType(), True),
    T.StructField('provider_id', T.LongType(), True),
    T.StructField('days_supply', T.IntegerType(), True),
    T.StructField('quantity', T.FloatType(), True),
    T.StructField('person_id', T.LongType(), True),
    T.StructField('drug_exposure_id', T.LongType(), True),
    T.StructField('drug_concept_id', T.IntegerType(), True),
    T.StructField('drug_exposure_start_date', T.DateType(), True),
    T.StructField('drug_exposure_start_datetime', T.TimestampType(), True),
    T.StructField('drug_exposure_end_date', T.DateType(), True),
    T.StructField('drug_exposure_end_datetime', T.TimestampType(), True),
    T.StructField('drug_type_concept_id', T.IntegerType(), True),
    T.StructField('stop_reason', T.StringType(), True),
    T.StructField('refills', T.IntegerType(), True),
    T.StructField('route_concept_id', T.IntegerType(), True),
    T.StructField('lot_number', T.StringType(), True),
    T.StructField('drug_source_value', T.StringType(), True),
    T.StructField('drug_source_concept_id', T.IntegerType(), True),
    T.StructField('route_source_value', T.StringType(), True),
    T.StructField('dose_unit_source_value', T.StringType(), True),
